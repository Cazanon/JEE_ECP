...
public abstract class GenericDaoJdbc<T, ID> {
    ...
    public static Connection getConnection() {
        try {
            ...
            LogManager.getLogger(GenericDaoJdbc.class).error(
    ...
    public static void dropAndCreateTables() {
        try {
            ...
            LogManager.getLogger(GenericDaoJdbc.class).error("Drop tables: " + e.getMessage());
        }
    }
